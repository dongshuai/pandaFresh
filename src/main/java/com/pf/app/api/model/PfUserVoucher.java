...
@Table(name = "pf_user_voucher")
public class PfUserVoucher implements Serializable {
    /**
     * 用户主键
     */
    @Id
     ...
     * 获取用户红包总值单位：分
     *
     * @return total_amount - 用户红包总值单位：分
     */
    ...
    public boolean equals(Object that) {
        ...
        PfUserVoucher other = (PfUserVoucher) that;
